...
namespace Shop.Web.Controllers
{
    public class ProductController : SiteBaseController
    {
        ...
        public async Task<IActionResult> CrerateProductComment(CreateProductCommentViewModel createProductComment)
        {
            if (!string.IsNullOrEmpty(createProductComment.Text))
            {
                ...
                switch (result)
                {
                    case CreateProductCommentResult.ChechUser:
                        TempData[WarningMessage] = "کاربر مورد نظر یافت نشد";
                        break;
                    case CreateProductCommentResult.ChechPoduct:
            ...
            TempData[ErrorMessage] = "لطفا نظر خود را وارد نمائید";
            return RedirectToAction("ProductDetail", new { productId = createProductComment.ProductId });
        }
        #endregion
